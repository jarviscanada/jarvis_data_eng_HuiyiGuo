...
public interface LambdaStreamExc {
     ...
     * e.g.
     * filter(stringStream, "a") wil return another stream which no element contains a
     *
     *
     * @param stringStream
     * @param pattern
    ...
    /**
     * filter all even number and return odd numbers  from a int Stream
     * @param intStream
     * @return
     */
     ...
     *
     * You will learn:
     *   - functional interface https://bit.ly/2pTXRwM & http://bit.ly/33onFig
     *   - lambda syntax
     *
     * e.g.
     ...
     * @param printer
     */
    void printOdd(IntStream intSteam, Consumer<String> printer);
